...
namespace WPWaxCustomerSupportApp\Utility;
	...
	public function register_js_scripts( array $args = [] ) {
		...
		foreach( $args['scripts'] as $handle => $script_args ) {
			$default = [
				...
				'src_path'  => WPWAX_CUSTOMER_SUPPORT_APP_SRC_PATH,
				'link'      => '',
				'deps'      => [],
				'ver'       => $this->script_version,
				'has_rtl'   => false,
			...
			if ( WPWAX_CUSTOMER_SUPPORT_APP_IN_DEVELOPMENT ) {
				...
				$script_args['base_path'] = WPWAX_CUSTOMER_SUPPORT_APP_VITE_HOST_BASE . $script_args['src_path'];
			}
