...
(function(exports) {
  {
    (function() {
      ...
      var ReactElement = function(type, key, ref, self, source2, owner, props) {
        var element = {
      ...
      function createElement(type, config, children) {
        ...
        return ReactElement(type, key, ref, self, source2, ReactCurrentOwner.current, props);
      }
      ...
      function cloneElement(element, config, children) {
        ...
        return ReactElement(element.type, key, ref, self, source2, owner, props);
      }
 ...
 */
{
  (function() {
    ...
    function useMutableSource(hook, source2, getSnapshot, subscribe2) {
      ...
      }, [getSnapshot, source2, subscribe2]);
      dispatcher.useEffect(function() {
        ...
        var unsubscribe2 = subscribe2(source2._source, handleChange);
        {
      ...
      if (!objectIs(prevGetSnapshot, getSnapshot) || !objectIs(prevSource, source2) || !objectIs(prevSubscribe, subscribe2)) {
        var newQueue = {
          pending: null,
          dispatch: null,
    ...
    function mountMutableSource(source2, getSnapshot, subscribe2) {
      ...
      return useMutableSource(hook, source2, getSnapshot, subscribe2);
    }
    ...
    var InvalidNestedHooksDispatcherOnRerenderInDEV = null;
    {
      ...
      HooksDispatcherOnMountInDEV = {
        ...
        useMutableSource: function(source2, getSnapshot, subscribe2) {
          ...
          mountHookTypesDev();
          return mountMutableSource(source2, getSnapshot, subscribe2);
        },
      ...
      HooksDispatcherOnUpdateInDEV = {
        ...
        useMutableSource: function(source2, getSnapshot, subscribe2) {
          currentHookNameInDev = "useMutableSource";
          updateHookTypesDev();
          return updateMutableSource(source2, getSnapshot, subscribe2);
        },
        useOpaqueIdentifier: function() {
          currentHookNameInDev = "useOpaqueIdentifier";
          updateHookTypesDev();
...
function createSubscription(store, parentSub) {
  ...
  function trySubscribe() {
    if (!unsubscribe2) {
      unsubscribe2 = parentSub ? parentSub.addNestedSub(handleChangeWrapper) : store.subscribe(handleChangeWrapper);
...
function createStore(reducer, preloadedState, enhancer) {
  ...
  if (typeof enhancer !== "undefined") {
    if (typeof enhancer !== "function") {
      throw new Error("Expected the enhancer to be a function. Instead, received: '" + kindOf$1(enhancer) + "'");
    }
    return enhancer(createStore)(reducer, preloadedState);
  }
  if (typeof reducer !== "function") {
    throw new Error("Expected the root reducer to be a function. Instead, received: '" + kindOf$1(reducer) + "'");
  }
  ...
  function subscribe2(listener) {
    if (typeof listener !== "function") {
      throw new Error("Expected the listener to be a function. Instead, received: '" + kindOf$1(listener) + "'");
    }
    if (isDispatching) {
  ...
  function replaceReducer(nextReducer) {
    if (typeof nextReducer !== "function") {
      throw new Error("Expected the nextReducer to be a function. Instead, received: '" + kindOf$1(nextReducer));
    }
    ...
    return _ref = {
      subscribe: function subscribe3(observer) {
        if (typeof observer !== "object" || observer === null) {
          throw new Error("Expected the observer to be an object. Instead, received: '" + kindOf$1(observer) + "'");
        }
...
function bindActionCreators(actionCreators, dispatch) {
  ...
  if (typeof actionCreators !== "object" || actionCreators === null) {
    throw new Error("bindActionCreators expected an object or a function, but instead received: '" + kindOf$1(actionCreators) + `'. Did you write "import ActionCreators from" instead of "import * as ActionCreators from"?`);
  }
...
var redux = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
export { Provider as P, React as R, _defineProperty as _, combineReducers as a, applyMiddleware as b, createStore as c, compose as d, axios as e, useSelector as f, reactIs as g, hoistNonReactStatics_cjs as h, redux as i, React$1 as j, reactDom as k, objectAssign as o, react as r, thunk$1 as t, useDispatch as u };
