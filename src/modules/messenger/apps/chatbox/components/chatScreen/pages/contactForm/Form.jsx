...
import { upateFormData as upateUserFormData, upateState as upateUserState } from "../../../../store/forms/user/actionCreator";
        ...
        <form onSubmit={submitHandler} className="wpwax-vm-h-100pr">
            <div className="wpwax-vm-h-100pr wpwax-vm-d-flex wpwax-vm-flex-direction-column">
				<div className="wpwax-vm-body wpwax-vm-flex-grow-1">
                    ...
                    <div className="wpwax-vm-form-group">
                        <input ref={emailRef} type="email" className="wpwax-vm-form__element" placeholder="Your email*" />
                    </div>
				</div>
